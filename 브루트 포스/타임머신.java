...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        if(canHour == 1 && canOther == 3) {  // 시간으로 쓸 수 있는 숫자가 1개고 분초로 쓸 수 있는 숫자가 전체라면 시간을 고정으로 넣어놓고 분초만 바꾸는 2가지 경우이다
            bufW.write(2 + "\n");
            ...
            bufW.write(6 + "\n");
        } else {  // 그 외의 경우는 분초가 3보다 작은 숫자인 경우거나 시간으로 쓸 수 있는 숫자가 없는 경우 이므로 만들 수 있는 조합이 없다
            bufW.write(0 + "\n");
        }
